                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {premiumCategories.map((cat) => (
                                    <div
                                        ...
                                        className="relative overflow-hidden rounded-2xl cursor-pointer group hover:scale-[1.02] transition-all duration-300 shadow-lg border border-white/5 hover:border-amber-400/50"
                                    >
                                        {/* Background Gradient */}
